...
HRESULT D3D11CreateTextureFromFile(_In_ ID3D11Device *d3dDevice, _In_opt_ ID3D11DeviceContext *d3dContext,
                                   _In_z_ const char *fileName, _Out_opt_ ID3D11Resource **texture,
                                   ...
                                   _In_ size_t maxsize)
{
    ...
    if (texture != 0 || textureView != 0)
    {
        ...
        {
            (*texture)->SetPrivateData(WKPDID_D3DDebugObjectName, static_cast<UINT>(strnlen_s(fileName, MAX_PATH)),
                                       pstrName);
        }
